...
1. **Consuming the UI Kit**: If you are integrating these components into an application (e.g. `figma-plugin`), read `USAGE.md`.
2. **Contributing to the UI Kit**: If you are building, fixing, or modifying components _inside_ this `adapter-mantine-v8` package, read `CONTRIBUTING.md`.
