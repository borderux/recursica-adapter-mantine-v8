...
export function generateMantineTheme({
  ...
  for (const [key, value] of Object.entries(processTokens.tokens)) {
  ...
  for (const color of processTokens.colors) {
  ...
  for (const [key, value] of Object.entries(processTokens.breakpoints)) {
...
export const mantineTheme = createTheme({
  ...
  breakpoints: {
    ${Object.entries(processTokens.breakpoints)
