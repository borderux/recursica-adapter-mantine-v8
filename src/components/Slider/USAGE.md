...
This document describes how to integrate and use the `Slider` component in your projects using `@recursica/adapter-mantine-v8`.
...
```tsx
import { Slider } from "@recursica/adapter-mantine-v8";
```
