...
This document describes how to integrate and use the `Panel` component in your projects using `@recursica/adapter-mantine-v8`.
...
```tsx
import { Panel } from "@recursica/adapter-mantine-v8";
```
