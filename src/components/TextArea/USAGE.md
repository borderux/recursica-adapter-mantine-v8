...
This document describes how to integrate and use the `TextArea` component in your projects using `@recursica/adapter-mantine-v8`.
...
```tsx
import { TextArea } from "@recursica/adapter-mantine-v8";
```
