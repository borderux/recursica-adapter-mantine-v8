...
This document describes how to integrate and use the `Popover` component in your projects using `@recursica/adapter-mantine-v8`.
...
```tsx
import { Popover } from "@recursica/adapter-mantine-v8";
```
