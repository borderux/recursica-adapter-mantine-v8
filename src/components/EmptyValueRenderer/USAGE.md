...
This document describes how to integrate and use the `EmptyValueRenderer` component in your projects using `@recursica/adapter-mantine-v8`.
...
```tsx
import { EmptyValueRenderer } from "@recursica/adapter-mantine-v8";
```
